...
<div class="card card-body bg-light col-10 offset-1">
  <form name="boardfrm" id="boardfrm">
      ...
      <div class="form-group row">
        ...
        <input type="text" id="userid" name="userid" class="form-control col-9 border-danger" value="${UID}" readonly>
      </div>
      <div class="form-group row">
      ...
      <div class="form-group row">
          ...
          <div class="col-12 text-center">
            <button type="button" id="savebdbtn" class="btn btn-primary"><i class="fas fa-check-circle"></i> 입력완료</button>
            <button type="reset" class="btn btn-danger"><i class="fas fa-times-circle"></i>취소하기</button>
          </div>
      </div>
  </form>
</div>
