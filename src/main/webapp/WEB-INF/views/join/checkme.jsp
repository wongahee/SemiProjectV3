...
<div class="row">
    <div class="col-5 offset-1"><!--앞한칸띄우기-->
        ...
        <div class="form-group row">
            ...
            <input type="text" name="jumin1" id="jumin1" class="col-3 border-warning form-control">
            <span class="col-form-label">&nbsp;&mdash;&nbsp;</span><!-- 중앙으로 내리기 -->
            <input type="text" name="jumin2" id="jumin2" class="col-3 border-warning form-control">
        </div>
        <div class="form-group row">
